                ...
                <table class="table table-striped table-bordered mt-3" id="example">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>John Doe</td>
                            <td>
                                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#viewConcern">View</button>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="#">
                        <textarea name="" placeholder="Reply..." class="form-control" id=""></textarea>
