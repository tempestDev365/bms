...
<body>
        <div class="a4-page bg-light" >
            ...
            <div class="a4-main d-flex mt-4" style="gap: 10px;">
                <div class="a4-aside-content py-3 d-flex flex-column justify-content-evenly align-items-center" style="min-width: 200px; width: 300px; height: 800px; border: 2px solid rgb(13, 13, 159); border-radius: 20px;">
                ...
                <div class="a4-main-content text-secondary text-center py-3"style="flex-grow: 1;">
                    ...
                    <label style="text-align: left;" class="mx-2">
                        This is to certify that the above-mentioned individual is a bona fide resident / voter of this barangay. According to the records kept in this office, the individual has no pending cases. The resident is known to me to possess GOOD MORAL CHARACTER and is a law-abiding citizen of this community. 
                        This Barangay Certificate is issued upon request for <?php echo $resident_information['resident_fullname']  ?> </label>
                    </label>
