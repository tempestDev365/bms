            ...
            <div class="a4-main d-flex mt-4" style="gap: 10px;">
                ...
                <div class="a4-main-content text-secondary text-center py-3"style="flex-grow: 1;">
                    ...
                    <label style="text-align: left;" class="mx-2">
                        ...
                        According to the records kept in this office, the individual has no pending cases. The resident is known to me to possess GOOD MORAL CHARACTER and is a law-abiding citizen of this community.
