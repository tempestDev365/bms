        ...
        <div class="a4-page bg-light" >
            ...
            <div class="a4-aside-content py-3 d-flex flex-column justify-content-evenly align-items-center" style="min-width: 200px; width: 400px; height: 800px; border: 2px solid rgb(13, 13, 159); border-radius: 20px;">
                ...
                <div class="a4-main-content text-secondary text-center py-3"style="flex-grow: 1;">
                    <label style="font-size: 1.6rem;">OFFICE OF PUNONG BARANGAY</label>
                    <label style="font-size: 1.8rem;">BARANGAY CERTIFICATE OF NON-RESIDENCY</label>
                    ...
                    <label style="text-align: left;" class="mx-2">
                        This is to certify that the above-mentioned individual is NOT a resident of this barangay. According to the records kept in this office, the individual does not appear as a registered resident or voter of this barangay.
